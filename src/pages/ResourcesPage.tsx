  ...
  setBooks([]);
    ...
    const fetchVerses = async () => {
      try {
        ...
        console.log('Verses API response:', response.data);
        ...
        if (Array.isArray(response.data)) {
          ...
          setError(prev => ({ ...prev, verses: 'Received invalid data format from server.' }));
          setVerses([]); // Initialize with empty array to avoid map errors
        }
