          ...
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/about">
                  <Button className="bg-church-gold hover:bg-yellow-600 text-black">
                    Learn More
                  </Button>
                </Link>
                <Link to="/announcements">
                  <Button variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-church-navy">
                    Upcoming Events
                  </Button>
                </Link>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="mt-8">
                  <Link to="/about">
                    <Button className="bg-church-navy hover:bg-blue-900">
                      Learn More About Us
                    </Button>
                  </Link>
                </div>
